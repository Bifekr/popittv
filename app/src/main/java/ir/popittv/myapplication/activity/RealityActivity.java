...
//-------------End On Create-------------------------
    ...
    private void initNewRv(RealityActivity realityActivity, RealityActivity realityActivity1) {
        ...
        infinitAdapter2 = new InfinitFrg1_PagerAdapter(RealityActivity.this,realityActivity1);
    ...
    private void getChannel_detail() {
        mainViewModel.getChannel_detail().observe(this, channelDataModel -> {
            ...
            if (channelDataModel!=null) {
                ...
                Toast.makeText(RealityActivity.this, "انترنت خود را بررسی کنید", Toast.LENGTH_LONG).show();
                mainViewModel.requestChannel_detail(40, KIND);
            }
    ...
    private void getFunny_subMenu() {
        ...
        mainViewModel.getFunny_subMenu().observe(this, funnyDataModels -> {
            if (funnyDataModels!=null) {
                ...
                Toast.makeText(RealityActivity.this, "فقط از ای پی ایران استفاده کنید", Toast.LENGTH_SHORT).show();
                mainViewModel.requestFunny_subMenu(0, KIND);
            }
        });
    }
